...
@MessageDriven(activationConfig = {
        ...
        @ActivationConfigProperty(propertyName = "destinationLookup",
                propertyValue = "jms/queue/seventhQueue"),
        @ActivationConfigProperty(propertyName = "maxSession",
                propertyValue = "40")
})
public class SeventhMDBBean implements MessageListener {
    ...
    /**
     * Метод, который обрабатывает сообщение из очереди `seventhQueue`.
     *
