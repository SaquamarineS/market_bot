...
@MessageDriven(activationConfig = {
        ...
        @ActivationConfigProperty(propertyName = "destinationLookup",
                propertyValue = "jms/queue/fourthQueue"),
        @ActivationConfigProperty(propertyName = "maxSession",
                propertyValue = "40")
})
public class FourthMDBBean implements MessageListener {
    ...
    /**
     * Метод, который обрабатывает сообщение из очереди четвертого MDB.
     *
